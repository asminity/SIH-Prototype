...
export const routes: RouteDefinition[] = [
  ...
  },
  {
    ...
    icon: Network,
    eyebrow: 'GRAPH INTELLIGENCE',
    description: 'Examine relationship strength and investigative context across entities.',
  },
  {
    path: '/threat-fusion',
    label: 'AI Threat Fusion',
    section: 'INVESTIGATION',
    icon: BrainCircuit,
    eyebrow: 'AI THREAT INTELLIGENCE',
    description: 'Unified multi-model neural consensus engine uniting on-chain graph heuristics and network telemetry.',
  },
  {
    path: '/ai-alerts',
    label: 'Threat Alerts',
